<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="OkulKayıt.Login" %>
<!DOCTYPE HTML>

<html lang="en">

<head>
    <title>My School Education By Can Calkan</title>
    <!-- Meta tag Keywords -->
...
<body>
    ...
    <header>
        <div class="container">
            <div class="header d-lg-flex justify-content-between align-items-center py-2 px-sm-2 px-1">
                <!-- logo -->
                <div id="logo">
                    <h1><a href="Index.aspx">Can Calkan</a></h1>
                </div>
                <!-- //logo -->
                <!-- nav -->
            ...
            <div class="modal-body my-5 pt-4">
                ...
                <form action="#" method="post" runat="server">
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="TextBox1" PlaceHolder="UserName" runat="server" Width="550px"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">Password</label>
                        <asp:TextBox ID="TextBox2" PlaceHolder="Password"  TextMode="Password" runat="server" Width="550px"></asp:TextBox>
                    </div>
                     <div>
                        <asp:Button ID="Button1" runat="server" CssClass="btn btn-warning" Text="Login" Width="150px" OnClick="Button1_Click"/>
                     </div> 
                    ...
                    <p class="text-center dont-do text-style-w3ls text-li">Don't have an account?
                        <a href="KayitOl.Aspx" class="font-weight-bold text-li">
                            Register Now</a>
                        </p>
                </form>
            </div>
        ...
        <div class="container py-xl-4 py-lg-3">
            <div class="row footer-grids">
                ...
                <div class="col-lg-2 col-6 footer-grid footer-contact mt-lg-0 mt-4">
                    ...
                    <ul class="list-unstyled">
                        <li>
                            <a href="tel:+905546443862">+905546443862</a>
                        </li>
                        <li>
                            <a href="mailto:cancalkaniletisim@gmail.com">cancalkaniletisim@gmail.com</a>
                        </li>
                    </ul>
                </div>
    ...
    <div class="copyright-w3ls py-4">
        <div class="container">
            <div class="row">
                <!-- copyright -->
                <p class="col-lg-8 copy-right-grids text-wh text-lg-left text-center mt-lg-2">© 2020 My School. All
                    Rights Reserved | Design by
                    <a href="https://cancalkan.github.io/" target="_blank">Can Calkan</a>
                </p>
                <!-- //copyright -->
                <!-- social icons -->
