<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KayitOl.aspx.cs" Inherits="OkulKayıt.KayitOl" %>

<!DOCTYPE HTML>
<html lang="zxx">

<head>
    <title>Can Calkan School Register Project</title>
    <!-- Meta tag Keywords -->
...
<body>
            ...
            <div class="modal-body mt-md-2 mt-5">
                ...
                <form action="#" method="post" runat="server">
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control" placeholder="Your Name and Surname "></asp:TextBox>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                       ...
                       <asp:TextBox ID="TextBox4" runat="server" CssClass="form-control" placeholder="Your City" OnTextChanged="TextBox4_TextChanged"></asp:TextBox>
                    </div>
    ...
    <div class="copyright-w3ls py-4">
        <div class="container">
            <div class="row">
                <!-- copyright -->
                <p class="col-lg-8 copy-right-grids text-wh text-lg-left text-center mt-lg-2">© 2020 Can Calkan School Project. All 
